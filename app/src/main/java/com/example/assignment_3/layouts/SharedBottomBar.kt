...
fun SharedBottomBar() {
    ...
    NavigationBar(
        ...
        NavigationBarItem(
            ...
            label = { Text(text = "Add") },
            selected = currentDesination?.route?.startsWith(Routes.AddRecipe.route) == true,
        ...
        NavigationBarItem(
            ...
            selected = currentDesination?.route?.startsWith(Routes.RecipeList.route) == true,
        ...
        NavigationBarItem(
            ...
            selected = currentDesination?.route?.startsWith(Routes.About.route) == true,
